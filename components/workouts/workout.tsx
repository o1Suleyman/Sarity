...
export default function Workout({ id }: { id: string | null }) {
    ...
    const handleAddSet = async () => {
        ...
        setIsAddingSet(true);
        const db = await createClient();
        const { data, error } = await db.from("sets").insert({
            name: newSetName,
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                {loading ? (
                    ...
                    sets.map((set) => {
                        ...
                        const imageUrl = exerciseImages[set.name as ExerciseName] || "/exercises/default.jpg";
            ...
            <div className="mt-8">
                <Drawer>
                    <DrawerTrigger asChild>
                        <Button><Plus className="mr-2" /> Add Set</Button>
                    </DrawerTrigger>
                    <DrawerContent>
                        <DrawerHeader>
                        ...
                        <div className="p-4 space-y-4">
                            ...
                            <div className="flex justify-end gap-2">
                                <DrawerClose asChild>
                                    <Button variant="outline" disabled={isAddingSet}>Cancel</Button>
                                </DrawerClose>
                                <DrawerClose asChild>
                                    <Button
